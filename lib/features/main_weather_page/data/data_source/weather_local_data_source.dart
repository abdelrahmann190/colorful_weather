...
import 'package:colorful_weather/features/core/utils/json_serializer.dart';
import 'package:colorful_weather/features/main_weather_page/data/models/current_weather_model.dart';
...
class WeatherLocalDataSourceImpl implements WeatherLocalDataSource {
  ...
  @override
  Future<void> cacheWeeklyForecastWeatherData(
    List<WeeklyForeCastModel> weeklyForeCastListToBeCached,
    int currentCityIndex,
  ) {
    final List listToBeStored = weeklyForeCastListToBeCached
        .map(
  ...
  @override
  Future<void> updateSavedCitiesList(List<String> savedCitiesList) async {
