...
import 'package:colorful_weather/features/main_weather_page/presentation/widgets/city_selection_dialog.dart';
import 'package:colorful_weather/features/main_weather_page/presentation/widgets/saved_cities_dialog.dart';

import 'weather_data_type_dialog.dart';
...
class MenuItems {
  ...
  static onChanged({
    ...
    required List<String> savedCitiesList,
